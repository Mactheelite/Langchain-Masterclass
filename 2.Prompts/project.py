...
system_prompt = ChatPromptTemplate.from_messages([
    ("system", "You are a professional blog post writer. Help generate informative, engaging, and well-structured blog posts about {topic}."),
...
while True:
    ...
    # Sample topics and instructions to try:

    # Enter blog post topic: Langchain  
    # Ideas or instruction or type exit to finish: Just a 30 word post for the topic. menstion my name "Okorie"