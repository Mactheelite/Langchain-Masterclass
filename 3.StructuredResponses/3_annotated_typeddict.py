...
class Schema(TypedDict):
    ...
    summary: Annotated[str, "Must write a concise summary of the review in one sentences."]
    sentiment: Annotated[str, "Must write the overall sentiment of the review as either Positive, Negative, or Neutral."]
